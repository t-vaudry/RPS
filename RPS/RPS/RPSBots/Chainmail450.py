###############################################################################
#                                                                             #
# This is Chainmail450, an RPS program written by PotentProton.               #
#                                                                             #
...
# guarantee a 45% win rate against even the toughest opponents.               #
#                                                                             #
...
# strategy has a 45% chance of a win. This type of strategy is superior to    #
...
# chosen to guarantee 45% success, but this comes at a cost. There is         #
...
if input == "":
	...
	# Switch to a random strategy if we risk not being able to guarantee a 45%
	# chance of a win.
	if score <= -2:
		randstrat = 1
	if now > 406 and score <= -1:
		randstrat = 1
	if now > 786 and score <= 0:
		randstrat = 1
	if now > 976 and score <= 1:
		randstrat = 1
