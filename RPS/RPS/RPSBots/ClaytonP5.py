...
# ready to go
	...
	if rCount > rCount + pCount + sCount * .5:
		rWeight+= 1
	
	elif pCount > rCount + pCount + sCount * .5:
		pWeight+= 1
	
	elif sCount > rCount + pCount + sCount * .5:
		sWeight+= 1
	...
	if rockOccurrences > rockOccurrences + paperOccurrences + scissorsOccurrences * .5:
		rWeight+= 2
	
	elif paperOccurrences > rockOccurrences + paperOccurrences + scissorsOccurrences * .5:
		pWeight+= 2
	
	elif scissorsOccurrences > rockOccurrences + paperOccurrences + scissorsOccurrences * .5:
		sWeight+= 2
