#last time I submitted with the wrong name OTL.
#for this one, n =5 (last one n =4)
...
#haven't optimized anything. code looks so bad and runtime is also pretty bad too
import random
