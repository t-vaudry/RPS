...
import random
STRAT_RANDOM = False # include the random strategy
...
STRAT_NOISE = False  # include random noise even when a strategy is doing well
NOISE_CHANCE = .15  # use noise instead of the best strat this percent of the time
