...
if input == "":
  ...
  if sc == 0:
    ...
    tie_candidates[4] = counter[input]
    tie_candidates[5] = clock[input]
    ...
    win_candidates[4] = counter[input]
    win_candidates[5] = clock[input]
    ...
    lose_candidates[4] = counter[input]
    lose_candidates[5] = clock[input]
