###############################################################################
#                                                                             #
# This is Chainmail425, an RPS program written by PotentProton.               #
#                                                                             #
...
# guarantee a 42.5% win rate against even the toughest opponents.             #
#                                                                             #
...
# strategy has a 42.5% chance of a win. This type of strategy is superior to  #
...
# chosen to guarantee 42.5% success, but this comes at a cost. There is       #
...
if input == "":
	...
	# 42.5% chance of a win.
	if score <= -4:
		randstrat = 1
	if now > 150 and score <= -3:
		randstrat = 1
	if now > 486 and score <= -2:
		randstrat = 1
	if now > 738 and score <= -1:
		randstrat = 1
	if now > 905 and score <= 0:
		randstrat = 1
	if now > 989 and score <= 1:
		randstrat = 1
