...
if not input:
    ...
    next_strat = {"pattern": "Lizard", "Lizard": "Spock", "Spock": "Shotgun", "Shotgun": "Jellyfish", "Jellyfish": "Dynamite", "Dynamite": "Zombie", "Zombie": "pattern"}
    ...
    new_strat = next_strat[current_strat]
