# like zai_last series but looks at my hands
...
if not input:
   ...
   mixer_my_last = Mixer(0.6, LastMyBot(WIN), LastMyBot(TIE), LastMyBot(LOSE))
   mixer_op_last = Mixer(0.8, LastOpBot(WIN), LastOpBot(TIE), LastOpBot(LOSE))
   
   mixer = Mixer(0.9, mixer_my_last, mixer_op_last, RandomBot())
