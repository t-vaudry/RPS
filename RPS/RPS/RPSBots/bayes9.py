...
# Extension to bayes 7:
# guess, which of the 6 strategies the opponent follows. Keep track to which strategy the opponent
# switches after a loss/win/tie and add this to the probabilities.
