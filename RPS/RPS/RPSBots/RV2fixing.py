#Fixed a BUG!!! OTL (hope I actually fixed it)
#based off Centrifugal Bumblepuppy 4 by dllu
#change the idea of strategy to predictor so it can apply to not_lose (didn't for this one.)
#add one more kind of predict
#To win or not to lose 
#sdfsdf fightinguuuuuuuuu Wish me luck
import random
